...
func (p *StockCodeParser) Init(options ...func(*StockCodeParser) error) error {
	...
	_rules = [...]func() bool{
		...
		/* 1 Line <- <(Stock / ANY)> */
		nil,
		/* 2 Stock <- <(('$'? Code (Suffix / (Suffix? '$'))) / ('(' Code ')') / ((&('(') ('(' (('N' 'Y' 'S' 'E') / ('N' 'A' 'S' 'D' 'A' 'Q')) ('：' / ':') SP* Code ')')) | (&('[') ('[' Code ']')) | (&('$') ('$' Code))))> */
		nil,
